...
/*     */   int segundos;
/*     */   
/*     */   public ManifiestosAgua(String[] datos) {
/*  31 */     this.con.consultar("agua", "configuraciones", "");
...
/*     */     
/*  42 */     File f = new File(this.archivo + "/" + this.archivo + ".xls");
/*     */     try {
/*  44 */       for (int i = 0; i < datos.length; i++) {
/*  45 */         System.out.println("Valores: " + i + " " + datos[i]);
/*     */       }
/*     */       
/*  48 */       Workbook libro1 = Workbook.getWorkbook(new File("Formatos/Agua.xls"));
...
/*  58 */       Label label = new Label(0, 5, "EQUIPO: " + datos[0]);
...
/*  64 */       label = new Label(7, 5, "POZO: " + datos[1]);
...
/*  70 */       label = new Label(17, 5, "PLATAFORMA: " + datos[2]);
...
/*  76 */       label = new Label(20, 7, datos[3]);
...
/*  96 */       label = new Label(4, 35, datos[7]);
...
/* 103 */       label = new Label(1, 39, datos[15]);
...
/* 111 */       label = new Label(9, 40, datos[8]);
...
/*     */       
/* 120 */       label = new Label(14, 40, datos[9]);
...
/* 127 */       label = new Label(23, 40, datos[10]);
...
/* 134 */       label = new Label(23, 41, datos[11]);
...
/* 141 */       label = new Label(4, 44, datos[13]);
...
/* 148 */       label = new Label(4, 43, datos[14]);
...
/* 163 */       label = new Label(17, 11, "Fecha de impresión: " + fecha.toLocaleString());
/* 164 */       label.setCellFormat((CellFormat)forma);
/* 165 */       hoja2.addCell((WritableCell)label);
/*     */       
/* 167 */       forma = new WritableCellFormat(fuente);
/* 168 */       forma.setBorder(Border.TOP, BorderLineStyle.getStyle(6));
/* 169 */       forma.setBorder(Border.BOTTOM, BorderLineStyle.getStyle(1));
/* 170 */       label = new Label(11, 42, datos[12]);
...
/* 176 */       fuente.setBoldStyle(WritableFont.NO_BOLD);
/* 177 */       forma = new WritableCellFormat(fuente);
/*     */       
/* 179 */       forma.setBorder(Border.BOTTOM, BorderLineStyle.getStyle(1));
/* 180 */       label = new Label(1, 44, datos[17] + ":");
/* 181 */       label.setCellFormat((CellFormat)forma);
/* 182 */       hoja2.addCell((WritableCell)label);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 222 */       copy.write();
/* 223 */       copy.close();
/* 224 */       JOptionPane.showMessageDialog(null, "<HTML>El manifiesto se ha creado satisfactoriamente en la dirección: <HR><B>" + f.getAbsolutePath() + "</B></HTML>", "Reporte Creado", 0, this.INFO);
/*     */     }
/* 226 */     catch (Exception i) {
/* 227 */       JOptionPane.showMessageDialog(null, "El archivo no se pudo crear por la siguiente razón:\n" + i.getMessage() + "\n" + i.getLocalizedMessage());
/*     */     } 
/*     */   }
/*     */ }


/* Location:              /Users/kamikaze07/Google Drive/Otros ordenadores/Mi MacBook Pro/Desktop/Sicret/SICRET.jar!/sicret/ManifiestosAgua.class
